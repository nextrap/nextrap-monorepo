const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      './01-overview.demo-b4dUU-0W.js',
      './types-4rIte7rE.js',
      './02-hover-style.demo-DC-USpHw.js',
      './main-DDVP600M.js',
      './main-BkomUfB9.css',
      './index-NZ9cz-wL.css',
      './03-form-action.demo-D1C8EO-E.js',
      './04-form-data.demo-Y76gzWXE.js',
      './05-validation.demo-878JZT58.js',
      './06-select-radio-vertical.demo-B0G97uen.js',
      './01-buttons.demo-zlD2Kr3g.js',
  ...
  getNavData() {
    ...
    for (const e of this.demos) {
      ...
      for (const [i, o] of n.entries()) {
        if (i === n.length - 1) {
          s.push({ name: this.getDemoLabel(o), href: this.getDemoHref(e.filename) });
          continue;
        }
...
const es = [
  {
    ...
    title: '01-overview',
    load: () =>
      U(() => import('./01-overview.demo-b4dUU-0W.js'), __vite__mapDeps([0, 1]), import.meta.url).then((r) =>
  ...
  },
  {
    ...
    load: () =>
      U(() => import('./02-hover-style.demo-DC-USpHw.js'), __vite__mapDeps([2, 1, 3, 4, 5]), import.meta.url).then(
  ...
  },
  {
    ...
    load: () =>
      U(() => import('./03-form-action.demo-D1C8EO-E.js'), __vite__mapDeps([6, 1, 3, 4, 5]), import.meta.url).then(
  ...
  },
  {
    ...
    title: '04-form-data',
    load: () =>
      U(() => import('./04-form-data.demo-Y76gzWXE.js'), __vite__mapDeps([7, 1, 3, 4, 5]), import.meta.url).then((r) =>
  ...
  },
  {
    ...
    title: '05-validation',
    load: () =>
      U(() => import('./05-validation.demo-878JZT58.js'), __vite__mapDeps([8, 1, 3, 4, 5]), import.meta.url).then((r) =>
  ...
  },
  {
    ...
    load: () =>
      U(
        () => import('./06-select-radio-vertical.demo-B0G97uen.js'),
  ...
  },
  {
    ...
    title: '01-buttons',
    load: () =>
      U(() => import('./01-buttons.demo-zlD2Kr3g.js'), __vite__mapDeps([10, 1, 11, 5]), import.meta.url).then((r) =>
