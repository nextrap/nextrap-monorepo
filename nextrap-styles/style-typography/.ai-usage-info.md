...
- Native `ul` and `ol` rules restore their complete standard list presentation after resets, including marker, indentation and rhythm. Specialized list components must explicitly override the standard properties they replace.
...
- SPA: `import '@nextrap/style-typography'` lädt API und Default-Light-DOM-Styles automatisch.
- Theme/Seaming: `import '@nextrap/style-typography/unstyled'` enthält keine direkten oder transitiven Light-DOM-Styles; Sass-Mixins explizit im Theme einbinden.
