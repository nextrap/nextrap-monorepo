import { CSSResult, customElement, html, NtSimpleElement, unsafeCSS } from '@nextrap/nt-framework';
...
class NtElementNavbar extends NtSimpleElement {
  ...
  override connectedCallback() {
    ...
    this.shadowRoot!.adoptedStyleSheets = [unsafeCSS(styleNavbar).styleSheet as CSSStyleSheet];
  }
}
