...
Diese Pairing-Demo zeigt `nte-accordion` innerhalb von `ntl-2col`: einmal in der Main-Spalte mit Bild in der Aside-Spalte und einmal in der Aside-Spalte ohne Bild.

## Accordion in Main, Bild in Aside

<ntl-2col style="--cols: 7;">
  <nte-accordion initial-open-index="0" exclusive="true">
    <section>
      <h3>Planung</h3>
...
<ntl-2col style="--cols: 7;">
  ...
  <nte-accordion class="aside" initial-open-index="0">
    <section>
