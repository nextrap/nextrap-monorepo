...
- `with-marker-start()` — Places the marker before the title. See the [accordion demo](../../demo/01-accordion.demo.ts).
- `with-marker-plus()` — Uses plus/minus marker icons. See the [accordion demo](../../demo/01-accordion.demo.ts).
