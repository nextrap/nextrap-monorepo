...
if (typeof document !== 'undefined' && defaultStyles.trim() && !document.getElementById('nextrap-default-nte-theme-switcher')) {
  const stylesheet = document.createElement('style');
  stylesheet.id = 'nextrap-default-nte-theme-switcher';
