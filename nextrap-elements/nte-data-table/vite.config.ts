...
export default defineConfig(() => ({
  ...
  build:{outDir:'../../dist/nextrap-elements/nte-data-table',emptyOutDir:true,lib:{entry: { index: 'index.ts', unstyled: 'unstyled.ts' },name:'nte-data-table',fileName: (_format, entryName) => `${entryName}.js`,formats:['es']},rollupOptions:{external:(id)=>!id.startsWith('.')&&!path.isAbsolute(id)}},
