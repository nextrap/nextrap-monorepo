...
import { NteParallaxBg } from './nte-parallax-bg';

describe('nte-parallax-bg', () => {
  let el: NteParallaxBg;

  beforeEach(() => {
    el = document.createElement('nte-parallax-bg') as NteParallaxBg;
  ...
  it('should create an element', () => {
    const element = new NteParallaxBg();
    expect(element).toBeInstanceOf(NteParallaxBg);
  });
  ...
  it('should set attributes via HTML', async () => {
    const customEl = document.createElement('nte-parallax-bg') as NteParallaxBg;
