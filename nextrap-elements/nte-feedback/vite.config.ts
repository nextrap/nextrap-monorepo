...
const projectName = 'nte-feedback';
const dirName = `nextrap-elements/nte-feedback`;

export default defineConfig(() => ({
  server: { port: 4000, host: '0.0.0.0', fixedPort: true, hmr: true },
  root: __dirname,
  ...
  test: {
    ...
    reporters: ['default'],
    coverage: { reportsDirectory: `../../coverage/${dirName}`, provider: 'v8' as const },
  },
}));
