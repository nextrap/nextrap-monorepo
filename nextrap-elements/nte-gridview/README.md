...
The `nte-gridview` component works exactly like a native HTML table, but with enhanced functionality:
...
| -------------------- | ------- | ------------------------ | ---------------------------------------------------- |
| `localStorageKey`    | String  | `'nte-gridview-columns'` | Key for storing column configuration in localStorage |
...
.nte-gridview thead th {
    background: #e3f2fd !important;
    color: #1976d2 !important;
}

/* Custom row hover effects */
.nte-gridview tbody tr:hover {
...
```html
<nte-gridview localStorage-key="projects-table">
    <thead>
        <tr>
            <th>ID</th>
            <th>Project Name</th>
...
```html
<nte-gridview localStorage-key="users-table">
    <thead>
        <tr>
            <th>Name</th>
            <th>Email</th>
