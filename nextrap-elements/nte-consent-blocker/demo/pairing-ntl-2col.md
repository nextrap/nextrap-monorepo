...
Diese Pairing-Demo zeigt `nte-consent-blocker` in `ntl-2col`: einmal als Aside-Spalte und einmal im `top`-Slot innerhalb des Wrapper-Rahmens.
...
<nte-consent-blocker class="default aside">
  <template>
...
<nte-consent-blocker class="default top">
  <template>
