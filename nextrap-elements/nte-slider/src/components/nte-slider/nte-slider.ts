...
import style from './nte-slider.scss?inline';

@customElement('nte-slider')
export class NteSliderElement extends SlotVisibilityMixin(
  SubLayoutApplyMixin(EventBindingsMixin(LoggingMixin(LitElement))),
) {
  static override styles = [unsafeCSS(style), unsafeCSS(resetStyle)];

  @property({ type: String, reflect: true })
  public accessor name = 'nte-slider';
