...
export default defineConfig(() => ({
  ...
  root: __dirname,
  cacheDir: '../../node_modules/.vite/nextrap-elements/nte-progress',
  plugins: [
    nxViteTsPaths(),
  ...
  build: {
    outDir: '../../dist/nextrap-elements/nte-progress',
    emptyOutDir: true,
  ...
  test: {
    ...
    reporters: ['default'],
    coverage: {
      reportsDirectory: '../../coverage/nextrap-elements/nte-progress',
